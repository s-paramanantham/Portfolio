  ...
  private readonly mockProjects: readonly ProjectBo[] = [
    {
      ...
      summary:
        'Large-scale enterprise precision medicine system serving Patients, Pharmacists, and Admins across 100+ modules and 300+ production screens. Features genomic report analysis, AI-driven drug/symptom/guideline checkers, video & chat consultations, test kit ordering, and multi-tenant admin management with Python/FastAPI backend and React frontend.',
      description: [
        ...
        'Implemented 3-role portal: Patients (upload genomic reports, generate action plans, AI drug/symptom/guideline checkers, order test kits, subscriptions, claims & coupons), Pharmacists (clinical reviews, video & chat consultations, pharmacogenomic alerts), and Admins (multi-tenant management, pharmacist assignments, payouts, HIPAA audit logs).',
      ...
      keyHighlights: [
        ...
        'Pharmacist consultation suite with integrated video & real-time chat',
      ...
      integrations: ['AWS Bedrock', 'AWS Cognito', 'PostgreSQL', 'WebSockets', 'SSE', 'HIPAA Logs'],
      isFeatured: true,
  ...
  private readonly mockCareerJourney: readonly CareerMilestoneBo[] = [
    {
      ...
      technicalOwnership: [
        ...
        'Real-Time Streaming & Consultation (WebSockets & SSE)',
