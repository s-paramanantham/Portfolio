  ...
  it('calls emailjs.send with mapped template parameters when keys are provided', async () => {
    ...
    expect(mockSend).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        name: 'Sarah Connor (sarah@example.com)',
        from_name: 'Sarah Connor (sarah@example.com)',
        sender_name: 'Sarah Connor (sarah@example.com)',
        user_name: 'Sarah Connor (sarah@example.com)',
        clean_name: 'Sarah Connor',
        email: 'sarah@example.com',
