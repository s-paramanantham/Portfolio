        ...
        <div className="lg:col-span-6 space-y-6">
          <GlassSurface intensity="high" borderGlow className="p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm font-semibold text-cyan-300">{education.institution}</p>
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="space-y-4">
            {coreValues.map((value, idx) => (
              ...
              >
                <div className="w-8 h-8 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 flex items-center justify-center font-mono font-bold text-xs shrink-0 group-hover:scale-110 group-hover:border-indigo-400 transition-all">
                  0{idx + 1}
                </div>
                <div>
